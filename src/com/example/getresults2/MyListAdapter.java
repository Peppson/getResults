...
public View getView(final int position, View convertView, ViewGroup parent) {
    ...
    if (convertView == null) {
        ...
        switch (type) {
        case 1:
            convertView = mInflater.inflate(R.layout.create_item_layout,parent, false);
            holder.name = (TextView) convertView.findViewById(R.id.textView_day);
            break;
        }
   ...
   Button Button1= (Button)  convertView.findViewById(R.id.button_add_exercise);
