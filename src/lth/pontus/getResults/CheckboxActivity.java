...
public class CheckboxActivity extends Activity {
	...
	private void displayListView() {
		...
		ArrayList<Exercise> currentList = MainActivity.exercisel
				.getExercises(position);

		// create an ArrayAdaptar from the String Array
		dataAdapter = new MyCustomAdapter(this, R.layout.checkbox_item_layout,
				currentList);
	...
	private void checkButtonClick() {
		...
		myButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				TextView row = (TextView) MainActivity.WeekdayRow
						.findViewById(R.id.textView_counter_number);
				int counter = 0;
